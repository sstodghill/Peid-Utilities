...
public class Base64Encoder
{
    ...
    //Sets
    void setEncodeUrl(boolean flag) { encodeUrl = flag; }
    void setDropPadding(boolean flag) { dropPadding = flag; }

    //Gets
    boolean isEncodeUrl() { return encodeUrl; }
    boolean isDropPadding() { return dropPadding; }
     /**
     * Testing the encoder.
